...
**Created:** 2026-09-15
**Status:** In progress(Step 1〜7 完了、夜間開発で遊びの仕組みを追加、2026-09-16)
...
仮称「てくてくまち」(世界観「湖畔のよりみち」)の検証版(MVP)を、React Native/Expoで作ってTestFlightで友人に配るところまでを計画する。サーバーは使わず、小物12種・飾る場所1つに絞る。2週間の観察結果で、本格開発に進むか、やめるか、方向を変えるかを判断する。
...
1. **アプリ名**: 仮称「てくてくまち」に決定(2026-09-15)。「てくてく」を使う自治体の健康アプリや散歩アプリが複数あるため、App Storeと商標の確認はリリース前に行う。
2. **街の世界観**: 「湖畔のよりみち」に決定(2026-09-15)。湖は盤面の外の固定背景。[アイデア出しの記録](../outputs/walk-town/2026-09-15-ideation-with-codex.md)
3. **絵の作り方の最終手段**: ChatGPTでタッチが揃わなければ、自分で描く、または外注するかを決める。
4. **テストに誘う友人**: 5〜8人、すばるが確保済み(2026-09-15)。
...
- 小物12種: ふつう=木のベンチ、丸い広葉樹、ヨシの植え込み、小さな花壇、丸灯の街灯、赤い郵便ポスト、かご付き自転車、木製の案内板／すこし珍しい=湖畔の喫茶スタンド、ソフトクリームの売店、手こぎボートの展示台／珍しい=小さな時計塔。
- 隣接の出来事2組(ベンチ+広葉樹→猫が昼寝、喫茶スタンド+自転車→かごに紙袋)と絵はがきモードをMVPに入れる。
...
- タッチは粘土のミニチュア風、草の台ごと1マスとして使うことに決定(2026-09-15)。何も置いていないマス用に台だけの絵も作る。
