...
> I have the `reel-editor` skill folder here. Read `reel-editor/SETUP.md` and set me up:
...
> folder to `~/.claude/skills/reel-editor` and confirm the skill is discoverable.
...
> Use the **reel-editor** skill. Default green style is fine.
