# reel-editor — a Claude Code skill
...
karaoke one-word subtitles, and music. The default look is a green "glass" style; the
...
2. **Install the skill**: move this whole `reel-editor/` folder into `~/.claude/skills/`
   so it lives at `~/.claude/skills/reel-editor/`.
   ```bash
