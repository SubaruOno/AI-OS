...
2. Read relevant workspace context:
   - The active constitution (`CLAUDE.md` or `AGENTS.md`) for workspace structure
...
5. **Classify the integration type** using the active constitution:
   - Is this a dual-harness Skill or a Claude Code-only shortcut?
...
3. After saving, report the file path and recommend create-plan to plan it or implement to build an approved plan.
