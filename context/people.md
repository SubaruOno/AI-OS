...
> Filled during install, 2026-09-01. 何かを頼れる人、頼りにされる人。セッションの中で自然に参照する。

### 河本薫先生

滋賀大学のゼミ担当教員(ビジネスデータサイエンティスト講座)。企業連携PBLを指導。コープさっぽろのIDPOS分析など、すばるの分析フレームワークの相談相手。ゼミの課題・進め方について頼れる人。

### 佐藤大地さん

滋賀大学データサイエンス学部の先輩(B4)。RAUD(野球データ分析チーム)、大阪ガス硬式野球部の分析まわりで一緒に動くことが多い相棒的存在。
